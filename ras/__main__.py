...
STAGES = {
    ...
    "harness-baseline": pipeline.harness_baseline,
    "harness-sft": pipeline.harness_sft,
    "harness-pruned": pipeline.harness_pruned,
    "harness-replaceme": pipeline.harness_replaceme,
